...
class Ion_auth_model extends CI_Model
{
	...
	public function add_to_group($group_ids, $user_id = FALSE)
	{
		...
		foreach ($group_ids as $group_id)
		{
			...
			case 2:
					...
					$data['rank_id'] = 3;
					$data['point'] = "";
					$this->db->insert('users_rank', $data);
				break;
			case 3:
					$data['user_id'] = $user_id;
					$data['rank_id'] = 2;
	...
	public function add_to_rank($group_ids, $user_id = FALSE)
	{
		switch ($group_ids) {
			case 2:
					$data['user_id'] = $user_id;
	...
	public function remove_from_group($group_ids = FALSE, $user_id = FALSE)
	{
		...
		if (!empty($group_ids))
		{
			...
			foreach ($group_ids as $group_id)
			{
				...
				$this->db->where('user_id', $user_id)->delete('users_rank');
	...
	public function remove_from_rank($user_id = FALSE)
	{
		$this->db->where('user_id', $user_id)->delete('users_rank');
	}
	/**
